...
Отследить интересующие операции в списке изменений, можно по хэшу коммита, при помощи команды `git show`

## 7. Перемещение между сохранениями коммитов
Для возвращения выбранного файла к состоянию на момент определенного коммита необходимо воспользоваться командой `git checkout хеш коммита`
