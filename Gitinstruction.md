...
Когда работа и проверка изменений закончены необходимо создать Pull Request -  запрос на вливание изменений из нашей ветки в основную ветку исходного репозитория. Таким образом они попадут к куратору проекта.

Чтобы создать Pull Request необходимо зайти на страницу репозитория. Справа от выпадающего меню с выбором ветки есть кнопка «New pull request».
