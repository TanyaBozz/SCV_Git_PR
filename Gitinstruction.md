...
```
А сдесь я оставлю это сообщение, чтобы создать конфликт, а потом успешно его разрешить.
...
```
В случае, когда в одинаковых файлах из разных веток мы отредактировали одну и туже часть кода по-разному возникает конфликтная ситуация.